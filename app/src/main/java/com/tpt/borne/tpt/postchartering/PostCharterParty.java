...
/**
 * Created by Jovan Milutinović on 12.6.2016..
 */
public class PostCharterParty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.postchartering_charter_party);
...
// Initializing array because of API
    ...
    private class HttpAsyncPostCharterParty extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progDailog = new ProgressDialog(PostCharterParty.this);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                JSONObject charterPArty = party.getJSONObject("charter_party");
                String description = charterPArty.getString("description");

                // HERE iS GING HTMNL
                textShipCharter = (TextView) findViewById(R.id.textSofComment);
                textShipCharter.setText(description);

                mainTextString = textShipCharter.getText().toString().replaceAll("(\r\n|\n)", "<br/>");
    ...
    public String POST(String url){
        ...
        try {
            ...
            jsonObject.accumulate("subject", "POST CHARTERING / CHARTER PARTY");
