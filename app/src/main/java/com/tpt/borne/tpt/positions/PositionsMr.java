 ...
 */
public class PositionsMr extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    String urlWeSend = "http://borne.io/tpt/api/vessels/all/?size=mr";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.positions_mr);
...
// Connecting user to parse accont
        ...
        logOut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PositionsMr.this, Login.class);
...
//        }
    ...
    private class HttpAsyncPositions extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progDailog = new ProgressDialog(PositionsMr.this);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                Log.e("MAIN JSON", String.valueOf(mainObject));
