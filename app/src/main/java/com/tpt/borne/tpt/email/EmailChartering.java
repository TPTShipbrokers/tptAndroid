 ...
 */
public class EmailChartering extends AppCompatActivity {
...
//        arr.put(obj);
        ...
        sendMail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (conn.isConnected(getBaseContext()) == false) {
                    ...
                    new AlertDialog.Builder(EmailChartering.this)
    ...
    private class HttpAsyncTaskSendMAil extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progDailog = new ProgressDialog(EmailChartering.this);
    ...
    public String POST(String url){
        ...
        try {
            ...
            jsonObject.accumulate("subject", "CHARTERING ENQUIRY");
