...
/**
 * Created by Borne on 6/15/2016.
 */
public class ShipDocumentation extends AppCompatActivity {
        ...
        downlaodDocuments.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (conn.isConnected(getBaseContext()) == false) {
                    ...
                    if (verifyStoragePermissions(ShipDocumentation.this) == true) {
                        startDownload();
                        toastCounter = 0;
                    }
    ...
    private class HttpAsyncShipDocumentation extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progDailog = new ProgressDialog(ShipDocumentation.this);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                final JSONArray shipDocumentation = party.getJSONArray("ship_documentations");
...
// LINEAR LAYOUT ZA MAIN In WHICH PUT OTHER LAYOUTS
                ...
                for (int i =0; i<shipDocumentation.length(); i++){
                    ...
                    model.setShipDocumentationid(c.getString("ship_documentation_id"));
...
// Setting imageview
    ...
    public boolean ifFileExists(String filename){
        ...
        File myFile = new File(extStore.getAbsolutePath() + "/tpt/documentation/"+filename);
    ...
    public String POST(String url){
        ...
        try {
            ...
            jsonObject.accumulate("subject", "CHARTER PARTY / CHARTERING");
