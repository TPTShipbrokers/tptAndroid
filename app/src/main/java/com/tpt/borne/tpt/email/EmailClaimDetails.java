...
/**
 * Created by Borne on 6/22/2016.
 */
public class EmailClaimDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.email_claim_details);
...
//        arr.put(obj);
        ...
        Intent i = getIntent();
        shipName = i.getStringExtra("shipName");


        headerName = (TextView) findViewById(R.id.status);
        headerName.setText(first+" "+last);

        mailText = "Dear TPT, \n\nI am contacting you with the request for more Claim details for "+shipName+".\nYou can send me Claim details on "+email+"\n\nRegards,\n"+first+" "+last;
        ...
        sendMail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (conn.isConnected(getBaseContext()) == false) {
                    ...
                    new AlertDialog.Builder(EmailClaimDetails.this)
    ...
    private class HttpAsyncTaskSendMAil extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progDailog = new ProgressDialog(EmailClaimDetails.this);
    ...
    public String POST(String url){
        ...
        try {
            ...
            jsonObject.accumulate("subject", "EMAIL CLAIM DETAILS");
