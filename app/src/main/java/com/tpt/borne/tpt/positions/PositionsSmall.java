 ...
 */
public class PositionsSmall extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    String urlWeSend = "http://borne.io/tpt/api/vessels/all/?size=handy";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.positions_small);
        ...
        positionsLr = (RelativeLayout) findViewById(R.id.activitiesButtThird);
        ...
        positionsLr.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Statics conn = new Statics(getBaseContext());
                if (conn.isConnected(getBaseContext()) == false) {
        ...
        logOut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PositionsSmall.this, Login.class);
...
//            new HttpAsyncPositions().execute("http://borne.io/tpt/api/vessels/all/?size=handy");
//            Log.e("GADJAMO ", "http://borne.io/tpt/api/vessels/all/?size=handy");
//        }else if(!(sireValue.equals("") && sireValue == null) && (temaValue.equals("") || temaValue == null) && (ageValue.equals("") || ageValue == null)){
//            new HttpAsyncPositions().execute("http://borne.io/tpt/api/vessels/all/?size=handy&sire=yes");
//            Log.e("GADJAMO ", "http://borne.io/tpt/api/vessels/all/?size=handy&sire=yes");
//        }else if((sireValue.equals("") || sireValue == null) && !(temaValue.equals("") && temaValue == null) && (ageValue.equals("") || ageValue == null)){
//            new HttpAsyncPositions().execute("http://borne.io/tpt/api/vessels/all/?size=handy&tema_suitable=yes");
//            Log.e("GADJAMO ", "http://borne.io/tpt/api/vessels/all/?size=handy&tema_suitable=yes");
//        }else if((sireValue.equals("") || sireValue == null) && (temaValue.equals("") || temaValue == null) && !(ageValue.equals("") && ageValue == null)){
//            new HttpAsyncPositions().execute("http://borne.io/tpt/api/vessels/all/?size=handy&age="+ageValue);
//            Log.e("GADJAMO ", "http://borne.io/tpt/api/vessels/all/?size=handy&age="+ageValue);
//        }else if(!(sireValue.equals("") && sireValue == null) && !(temaValue.equals("") && temaValue == null) && (ageValue.equals("") || ageValue == null)){
//            new HttpAsyncPositions().execute("http://borne.io/tpt/api/vessels/all/?size=handy&sire=yes&tema_suitable=yes");
//            Log.e("GADJAMO ", "http://borne.io/tpt/api/vessels/all/?size=handy&sire=yes&tema_suitable=yes");
//        }else if((sireValue.equals("") || sireValue == null) && !(temaValue.equals("") && temaValue == null) && !(ageValue.equals("") && ageValue == null)){
//            new HttpAsyncPositions().execute("http://borne.io/tpt/api/vessels/all/?size=handy&tema_suitable=yes&age="+ageValue);
//            Log.e("GADJAMO ", "http://borne.io/tpt/api/vessels/all/?size=handy&tema_suitable=yes&age="+ageValue);
//        }else if(!(sireValue.equals("") && sireValue == null) && (temaValue.equals("") || temaValue == null) && !(ageValue.equals("") && ageValue == null)){
//            new HttpAsyncPositions().execute("http://borne.io/tpt/api/vessels/all/?size=handy&sire=yes&age="+ageValue);
//            Log.e("GADJAMO ", "http://borne.io/tpt/api/vessels/all/?size=handy&sire=yes&age="+ageValue);
//        }else if(!(sireValue.equals("") && sireValue == null) && !(temaValue.equals("") && temaValue == null) && !(ageValue.equals("") && ageValue == null)){
//            new HttpAsyncPositions().execute("http://borne.io/tpt/api/vessels/all/?size=handy&sire=yes&tema_suitable=yes&age="+ageValue);
//            Log.e("GADJAMO ", "http://borne.io/tpt/api/vessels/all/?size=handy&sire=yes&tema_suitable=yes&age="+ageValue);
//        }
    ...
    private class HttpAsyncPositions extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progDailog = new ProgressDialog(PositionsSmall.this);
...
// GETTING ALL POST CHARTERING
                    for(int i =0; i<groups.length(); i++){
                        ...
                        Log.e("LIStA", listDataHeader.toString());
...
//                        postChartsList.add(model);
                    ...
                    adapterRec = new PositionsAdapter(getBaseContext(), listDataHeader, listDataChild);
