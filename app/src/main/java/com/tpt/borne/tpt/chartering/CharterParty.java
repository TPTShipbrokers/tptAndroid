 ...
 */
public class CharterParty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chartering_charter_party);
...
// Initializing array because of API
    ...
    private class HttpAsyncPostCharterParty extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progDailog = new ProgressDialog(CharterParty.this);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if(!(description.equals(""))){
                    ...
                    textShipCharter.setText("There is no data yet.");
                }
    ...
    public String POST(String url){
        ...
        try {
            ...
            jsonObject.accumulate("subject", "CHARTERING / CHARTER PARTY");
