 ...
 */
public class CharteringStatementOfFacts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chartering_statement_of_facts);
...
// Initializing array because of API
        ...
        if(sofComments.equals("")){
            textSofComment.setText("There is no data yet.");
        }else {
    ...
    private class HttpAsyncTaskSendMAil extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progDailog = new ProgressDialog(CharteringStatementOfFacts.this);
    ...
    public String POST(String url){
        ...
        try {
            ...
            jsonObject.accumulate("subject", "CHARTERING / STATEMENT OF FACT");
